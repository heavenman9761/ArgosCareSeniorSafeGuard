    ...
    if (widget.device.getDeviceType() == Constants.DEVICE_TYPE_HUB) {
      ...
      if (hubList.isNotEmpty) {
        Hub hub = Hub(
          ...
          shared: hubList[0].getShared(),
          ownerID: hubList[0].getOwnerID(),
          ownerName: hubList[0].getOwnerName(),
      ...
      if (sensorList.isNotEmpty) {
        Sensor sensor = Sensor(
          ...
          shared: sensorList[0].getShared(),
          ownerID: sensorList[0].getOwnerID(),
          ownerName: sensorList[0].getOwnerName(),
