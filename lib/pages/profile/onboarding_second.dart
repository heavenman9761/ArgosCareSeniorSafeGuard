...
import 'package:argoscareseniorsafeguard/pages/profile/onboarding_third.dart';

class OnSecondBoardingPage extends StatelessWidget {
  const OnSecondBoardingPage({super.key});
                ...
                SizedBox(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: [
                        Text("대상자의 현황을", style: TextStyle(fontSize: 14.sp, color: Colors.black, fontWeight: FontWeight.bold),),
                        RichText(
                            text: TextSpan(
                                text: "알림",
